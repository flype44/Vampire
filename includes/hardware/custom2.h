...
struct Custom2
{
    ...
    UWORD   hsstrt;          /*                                                 */
    UWORD   vsstrt;          /*                                                 */
    UWORD   hcenter;         /* Horizontal position for Vsync on interlace      */
    UWORD   diwhigh;         /* Display window - upper bits for Start/Stop      */
    UWORD   v_chunkyhmod;    /* Vampire chunky gfx - Horizontal Modulo          */
    UWORD   sprhpth;         /* UHRES sprite pointer (high 5 bits)              */
    UWORD   sprhptl;         /* UHRES sprite pointer (low 15 bits)              */
    UWORD   v_chunkypth;     /* Vampire chunky gfx - Plane pointer (hi 15 bits) */
    UWORD   v_chunkyptl;     /* Vampire chunky gfx - Plane pointer (lo 15 bits) */
    UWORD   v_chunkymode;    /* Vampire chunky gfx - Resolution and PixelFormat */
    UWORD   fmode;           /* Fetch mode register                             */
};
