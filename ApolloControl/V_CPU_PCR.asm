;----------------------------------------------------------
	...
	XDEF     _v_cpu_pcr_etu_a500
	XDEF     _v_cpu_pcr_etu_a1200	
...
;----------------------------------------------------------
; PCR: Enable Turtle Bits for A500
;----------------------------------------------------------
...
;----------------------------------------------------------
; PCR: Enable Turtle Bits for A1200
;----------------------------------------------------------

    cnop 0,4

_v_cpu_pcr_etu_a1200:
    movem.l  a5/a6,-(sp)
    move.l   $4.w,a6
    lea.l    .supv(pc),a5
    jsr      _LVOSupervisor(a6)
